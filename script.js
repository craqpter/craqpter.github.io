...
const todayTemperature = document.querySelector('.weather-today .temperature');
const tomorrowTemperature = document.querySelectorAll('.forecast-day .temperature')[0];
const dayAfterTomorrowTemperature = document.querySelectorAll('.forecast-day .temperature')[1];
